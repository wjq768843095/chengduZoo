...
class WxPayApi
{
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30){
        ...
        if($useCert == true){
            ...
            curl_setopt($ch,CURLOPT_SSLCERT, '/www/wwwroot/chengduZoo/vendor/wxpay/cert/apiclient_cert.pem');
            curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
            curl_setopt($ch,CURLOPT_SSLKEY, '/www/wwwroot/chengduZoo/vendor/wxpay/cert/apiclient_key.pem');
        }
